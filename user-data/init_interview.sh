#!/bin/bash
cat > /home/ec2-user/requirement.txt << EOL
You may install all the packages require if needed, you don't need to follow the sequence of the tasks and manage your own time.
